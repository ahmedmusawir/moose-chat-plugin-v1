...
define('MOOSE_CHAT_V1_URL', plugin_dir_url(__FILE__));
...
include plugin_dir_path(__FILE__) . 'includes/moose-chat-v1-shortcode.php';
// include plugin_dir_path(__FILE__) . 'includes/user-signup-hook.php';
